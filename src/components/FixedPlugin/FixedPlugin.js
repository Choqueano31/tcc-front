    ...
    >
      <div id="fixedPluginClasses" className={props.fixedClasses}>
        ...
        <ul className="dropdown-menu">
          <li className="header-title">Filtros da barra lateral</li>
          ...
          <li className="header-title">Fundo da barra lateral</li>
          <li className="adjustments-line">
            <a className="switch-trigger active-color">
              <div className="badge-colors text-center">
                <span
          ...
          <li className="adjustments-line">
            <a className="switch-trigger">
              <p className="switch-label">minimizar barra lateral</p>
              <Switch
          ...
          <li className="adjustments-line">
            <a className="switch-trigger">
              <p className="switch-label">Image da barra lateral</p>
              <Switch
                checked={showImage}
